...
from LDMP import log
from LDMP.calculate import DlgCalculateBase, get_script_slug
from LDMP.gui.DlgCalculateSQI import Ui_DlgCalculateSQI
from LDMP.api import run_script
from LDMP.sqi_setup import sqi_setup_widget
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMP", "Submitted"),
                           QtWidgets.QApplication.translate("LDMP", "Soil quality task submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
