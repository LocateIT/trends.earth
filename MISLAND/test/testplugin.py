...
from MISLAND.test.unit.test_dialog_settings import SettingsUnitSuite
from MISLAND.test.unit.test_calculate_ldn import CalculateLDNUnitSuite
from MISLAND.test.integration.test_calculate_ldn import CalculateLDNIntegrationSuite
from MISLAND.test.integration.test_calculate_urban import CalculateUrbanIntegrationSuite
