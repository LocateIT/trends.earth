...
from MISLAND.calculate import DlgCalculateBase, get_script_slug, ClipWorker, \
...
from MISLAND.gui.DlgCalculateRestBiomassData import Ui_DlgCalculateRestBiomassData
from MISLAND.gui.DlgCalculateRestBiomassSummaryTable import Ui_DlgCalculateRestBiomassSummaryTable
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("MISLAND", "Submitted"),
                           QtWidgets.QApplication.translate("MISLAND", "Restoration biomass change submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
            mb.pushMessage(QtWidgets.QApplication.translate("MISLAND", "Error"),
                           QtWidgets.QApplication.translate("MISLAND", "Unable to submit restoration biomass change task to Google Earth Engine."),
                           level=0, duration=5)
...
def make_summary_table(out_file, biomass_initial, biomass_change, area_site, 
    ...
    try:
        ...
        QtWidgets.QMessageBox.information(None, QtWidgets.QApplication.translate("MISLAND", "Success"),
                                      QtWidgets.QApplication.translate("MISLAND", u'Summary table saved to {}'.format(out_file)))
