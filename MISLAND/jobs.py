...
from MISLAND.download import Download, check_hash_against_etag, DownloadError
from MISLAND.layers import add_layer
...
class DlgJobs(QtWidgets.QDialog, Ui_DlgJobs):
    ...
    def __init__(self, parent=None):
        ...
        jobs_cache = self.settings.value("MISLAND/jobs_cache", None)
        if jobs_cache:
            ...
            if job['results'].get('type') != 'TimeSeriesTable':
                ...
                while not f:
                    ...
                    f, _ = QtWidgets.QFileDialog.getSaveFileName(self,
                                                          ...
                                                          self.settings.value("MISLAND/output_dir", None),
                    ...
                    if f:
                        if os.access(os.path.dirname(f), os.W_OK):
                            self.settings.setValue("MISLAND/output_dir", os.path.dirname(f))
