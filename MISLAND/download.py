...
from MISLAND.api import get_header
    ...
    def start(self):
        try:
            ...
            start_worker(worker, iface,
                         QtWidgets.QApplication.translate("MISLAND", u'Downloading {}').format(self.outfile))
            pause.exec_()
            ...
            QtWidgets.QMessageBox.critical(None,
                                       ...
                                       QtWidgets.QApplication.translate("MISLAND", "Download failed. Check your internet connection."))
            return False
        except requests.exceptions.ConnectionError:
            log("Download failed due to connection error")
            QtWidgets.QMessageBox.critical(None,
                                       QtWidgets.QApplication.translate("MISLAND", "Error"),
                                       QtWidgets.QApplication.translate("MISLAND", "Unable to access internet. Check your internet connection."))
            return False
        except requests.exceptions.Timeout:
            log('Download timed out.')
            QtWidgets.QMessageBox.critical(None,
                                       QtWidgets.QApplication.translate("MISLAND", "Error"),
                                       QtWidgets.QApplication.translate("MISLAND", "Download timed out. Check your internet connection."))
            return False
        except DownloadError:
            log("Download failed.")
            QtWidgets.QMessageBox.critical(None,
                                       QtWidgets.QApplication.translate("MISLAND", "Error"),
                                       QtWidgets.QApplication.translate("MISLAND", "Download failed. Task has expired. Kindly rerun task. "))
            return False
        return True
