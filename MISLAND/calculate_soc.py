...
from MISLAND.lc_setup import lc_setup_widget
from MISLAND.worker import AbstractWorker, StartWorker
from MISLAND.gui.DlgCalculateSOC import Ui_DlgCalculateSOC
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("MISLAND", "Submitted"),
                           QtWidgets.QApplication.translate("MISLAND", "Soil organic carbon submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
            mb.pushMessage(QtWidgets.QApplication.translate("MISLAND", "Error"),
                           QtWidgets.QApplication.translate("MISLAND", "Unable to submit soil organic carbon task to Google Earth Engine."),
                           level=0, duration=5)
