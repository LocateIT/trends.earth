...
from MISLAND.gui.DlgCalculateUrbanData import Ui_DlgCalculateUrbanData
from MISLAND.gui.DlgCalculateUrbanSummaryTable import Ui_DlgCalculateUrbanSummaryTable
from MISLAND.layers import get_band_infos, create_local_json_metadata, add_layer
...
def make_summary_table(areas, populations, out_file):
    ...
    try:
        ...
        log('Adding MISLAND logo to worksheet FAILED')
        pass
