...
from LDMS.calculate import DlgCalculateBase, get_script_slug, ClipWorker, \
...
from LDMS.gui.DlgCalculateRestBiomassData import Ui_DlgCalculateRestBiomassData
from LDMS.gui.DlgCalculateRestBiomassSummaryTable import Ui_DlgCalculateRestBiomassSummaryTable
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Submitted"),
                           QtWidgets.QApplication.translate("LDMS", "Restoration biomass change submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Error"),
                           QtWidgets.QApplication.translate("LDMS", "Unable to submit restoration biomass change task to Google Earth Engine."),
                           level=0, duration=5)
...
def make_summary_table(out_file, biomass_initial, biomass_change, area_site, 
    ...
    try:
        ...
        QtWidgets.QMessageBox.information(None, QtWidgets.QApplication.translate("LDMS", "Success"),
                                      QtWidgets.QApplication.translate("LDMS", u'Summary table saved to {}'.format(out_file)))
