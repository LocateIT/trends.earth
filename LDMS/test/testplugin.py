...
from LDMS.test.unit.test_dialog_settings import SettingsUnitSuite
from LDMS.test.unit.test_calculate_ldn import CalculateLDNUnitSuite
from LDMS.test.integration.test_calculate_ldn import CalculateLDNIntegrationSuite
from LDMS.test.integration.test_calculate_urban import CalculateUrbanIntegrationSuite
