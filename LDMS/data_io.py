...
from LDMS.gui.DlgDataIO import Ui_DlgDataIO
from LDMS.gui.DlgDataIOLoadTE import Ui_DlgDataIOLoadTE
from LDMS.gui.DlgDataIOLoadTESingleLayer import Ui_DlgDataIOLoadTESingleLayer
from LDMS.gui.DlgDataIOImportLC import Ui_DlgDataIOImportLC
from LDMS.gui.DlgDataIOImportSOC import Ui_DlgDataIOImportSOC
from LDMS.gui.DlgDataIOImportCQI import Ui_DlgDataIOImportCQI
from LDMS.gui.DlgDataIOImportProd import Ui_DlgDataIOImportProd
from LDMS.gui.DlgJobsDetails import Ui_DlgJobsDetails
from LDMS.gui.WidgetDataIOImportSelectFileInput import Ui_WidgetDataIOImportSelectFileInput
from LDMS.gui.WidgetDataIOImportSelectRasterOutput import Ui_WidgetDataIOImportSelectRasterOutput
from LDMS.gui.WidgetDataIOSelectTELayerExisting import Ui_WidgetDataIOSelectTELayerExisting
from LDMS.gui.WidgetDataIOSelectTELayerImport import Ui_WidgetDataIOSelectTELayerImport
...
class ImportSelectFileInputWidget(QtWidgets.QWidget, Ui_WidgetDataIOImportSelectFileInput):
    ...
    def open_raster_browse(self):
        if self.lineEdit_raster_file.text():
            ...
            initial_file = QSettings().value("LDMS/input_dir", None)
    ...
    def update_raster_layer(self, raster_file):
        ...
        if not os.access(raster_file, os.R_OK or not l.isValid()):
            ...
            QSettings().setValue("LDMS/input_dir", os.path.dirname(raster_file))
    ...
    def update_vector_layer(self, vector_file):
        ...
        if not os.access(vector_file, os.R_OK) or not l.isValid():
            ...
            QSettings().setValue("LDMS/input_dir", os.path.dirname(vector_file))
...
class ImportSelectRasterOutput(QtWidgets.QWidget, Ui_WidgetDataIOImportSelectRasterOutput):
    ...
    def save_raster(self):
        if self.lineEdit_output_file.text():
            ...
            initial_file = QSettings().value("LDMS/output_dir", None)
        ...
        if raster_file:
            if os.access(os.path.dirname(raster_file), os.W_OK):
                QSettings().setValue("LDMS/output_dir", os.path.dirname(raster_file))
...
class DlgDataIOImportLC(DlgDataIOImportBase, Ui_DlgDataIOImportLC):
    ...
    def load_agg(self, values):
        ...
        from LDMS.lc_setup import DlgCalculateLCSetAggregation
