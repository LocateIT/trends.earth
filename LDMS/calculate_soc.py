...
from LDMS.lc_setup import lc_setup_widget
from LDMS.worker import AbstractWorker, StartWorker
from LDMS.gui.DlgCalculateSOC import Ui_DlgCalculateSOC
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Submitted"),
                           QtWidgets.QApplication.translate("LDMS", "Soil organic carbon submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Error"),
                           QtWidgets.QApplication.translate("LDMS", "Unable to submit soil organic carbon task to Google Earth Engine."),
                           level=0, duration=5)
