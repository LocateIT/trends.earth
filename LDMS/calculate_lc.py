...
from LDMS.gui.DlgCalculateLC import Ui_DlgCalculateLC
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Submitted"),
                           QtWidgets.QApplication.translate("LDMS", "Land cover task submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Error"),
                           QtWidgets.QApplication.translate("LDMS", "Unable to submit land cover task to Google Earth Engine."),
                           level=0, duration=5)
