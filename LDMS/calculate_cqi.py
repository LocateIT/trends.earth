...
from LDMS.gui.DlgCalculateCQI import Ui_DlgCalculateCQI
from LDMS.api import run_script
from LDMS.cqi_setup import cqi_setup_widget
...
from LDMS.polling import Poller
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Submitted"),
                           QtWidgets.QApplication.translate("LDMS", "Climate quality task submitted to Google Earth Engine."),
                           level=0, duration=5)
