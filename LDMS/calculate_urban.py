...
from LDMS.gui.DlgCalculateUrbanData import Ui_DlgCalculateUrbanData
from LDMS.gui.DlgCalculateUrbanSummaryTable import Ui_DlgCalculateUrbanSummaryTable
from LDMS.layers import get_band_infos, create_local_json_metadata, add_layer
    ...
    def calculate_on_GEE(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Submitted"),
                           QtWidgets.QApplication.translate("LDMS", "Urban area change calculation submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Error"),
                           QtWidgets.QApplication.translate("LDMS", "Unable to submit urban area task to Google Earth Engine."),
                           level=0, duration=5)
