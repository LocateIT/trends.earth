...
from LDMS.api import get_header
    ...
    def start(self):
        try:
            ...
            start_worker(worker, iface,
                         QtWidgets.QApplication.translate("LDMS", u'Downloading {}').format(self.outfile))
            pause.exec_()
            ...
            QtWidgets.QMessageBox.critical(None,
                                       ...
                                       QtWidgets.QApplication.translate("LDMS", "Download failed. Check your internet connection."))
            return False
        except requests.exceptions.ConnectionError:
            log("Download failed due to connection error")
            QtWidgets.QMessageBox.critical(None,
                                       QtWidgets.QApplication.translate("LDMS", "Error"),
                                       QtWidgets.QApplication.translate("LDMS", "Unable to access internet. Check your internet connection."))
            return False
        except requests.exceptions.Timeout:
            log('Download timed out.')
            QtWidgets.QMessageBox.critical(None,
                                       QtWidgets.QApplication.translate("LDMS", "Error"),
                                       QtWidgets.QApplication.translate("LDMS", "Download timed out. Check your internet connection."))
            return False
        except DownloadError:
            log("Download failed.")
            QtWidgets.QMessageBox.critical(None,
                                       QtWidgets.QApplication.translate("LDMS", "Error"),
                                       QtWidgets.QApplication.translate("LDMS", "Download failed. Task has expired. Kindly rerun task. "))
            return False
        return True
