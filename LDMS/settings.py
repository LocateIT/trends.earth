...
from LDMS.gui.DlgSettings import Ui_DlgSettings
from LDMS.gui.DlgSettingsEdit import Ui_DlgSettingsEdit
from LDMS.gui.DlgSettingsEditForgotPassword import Ui_DlgSettingsEditForgotPassword
from LDMS.gui.DlgSettingsEditUpdate import Ui_DlgSettingsEditUpdate
from LDMS.gui.DlgSettingsLogin import Ui_DlgSettingsLogin
from LDMS.gui.DlgSettingsRegister import Ui_DlgSettingsRegister

from LDMS.api import get_user_email, get_user, delete_user, login, register, \
    update_user, recover_pwd
from LDMS.download import get_admin_bounds
...
class DlgSettingsRegister(QtWidgets.QDialog, Ui_DlgSettingsRegister):
    ...
    def register(self):
        ...
        if resp:
            ...
            settings.setValue("LDMS/email", self.email.text())
            settings.setValue("LDMS/password", None)
            return True
...
class DlgSettingsLogin(QtWidgets.QDialog, Ui_DlgSettingsLogin):
    ...
    def showEvent(self, event):
        ...
        password = settings.value("LDMS/password", None)
        if password:
    ...
    def login(self):
        ...
        if resp:
            ...
            settings.setValue("LDMS/jobs_cache", None)
            self.done(QtWidgets.QDialog.Accepted)
            self.ok = True
    ...
    def delete(self):
        ...
        if reply == QtWidgets.QMessageBox.Yes:
            ...
            if resp:
                ...
                settings.setValue("LDMS/password", None)
                settings.setValue("LDMS/email", None)
                self.close()
                self.ok = True
