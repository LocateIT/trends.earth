...
from LDMS.gui.DlgDownload import Ui_DlgDownload
...
class DlgDownload(DlgCalculateBase, Ui_DlgDownload):
    ...
    def btn_calculate(self):
        ...
        for row in rows:
            ...
            if resp:
                mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Success"),
                               QtWidgets.QApplication.translate("LDMS", "Download request submitted to Google Earth Engine."),
                               level=0, duration=5)
            else:
                mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Error"),
                               QtWidgets.QApplication.translate("LDMS", "Unable to submit download request to Google Earth Engine."),
                               level=0, duration=5)
