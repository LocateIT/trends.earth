...
from LDMS.gui.DlgCalculateForestFire import Ui_DlgCalculateForestFire as UiDialog
    ...
    def btn_calculate(self):
        ...
        if resp:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Submitted"),
                           QtWidgets.QApplication.translate("LDMS", "Forest Fire task submitted to Google Earth Engine."),
                           level=0, duration=5)
        else:
            mb.pushMessage(QtWidgets.QApplication.translate("LDMS", "Error"),
                           QtWidgets.QApplication.translate("LDMS", "Unable to submit forest fire task to Google Earth Engine."),
                           level=0, duration=5)
